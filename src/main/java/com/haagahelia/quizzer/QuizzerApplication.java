...
public class QuizzerApplication {
        ...
        public CommandLineRunner demo(TeacherService teacherService, CategoryService categoryService,
                ...
                return (args) -> {
                        ...
                        Choice scienceChoice1 = new Choice(true, "H2O");
                        Choice scienceChoice2 = new Choice(false, "H2O2");
                        Choice scienceChoice3 = new Choice(false, "D2O");
                        ...
                        // Quizzes
                        Quiz mathQuiz1 = new Quiz("Basic Math Quiz", "A series of basic math questions", "MATH101",
                                        true,
                                        Arrays.asList(mathQuestion));
                        mathQuestion.setQuiz(mathQuiz1);

                        Quiz scienceQuiz1 = new Quiz("Basic Science Quiz", "A series of basic science questions",
                                        "SCI101", true,
                                        Arrays.asList(scienceQuestion));
                        scienceQuestion.setQuiz(scienceQuiz1);

                        Quiz mathQuiz2 = new Quiz("Advanced Math Quiz", "A series of advanced math questions",
                                        "MATH201", true,
                                        null);
                        Quiz scienceQuiz2 = new Quiz("Advanced Science Quiz", "A series of advanced science questions",
                                        "SCI201",
                                        false, null);
